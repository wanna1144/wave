    ...
    <div class="wrap">
      ...
      <section class="board_input">
        <div class="center">
          ...
          <form name="answer_form" action="php/answer.php?num=<?=$content_num?>" method="post">
            <ul class="board_form">
              <li class="text_area clear">
                <span class="col1" style="height:200px; display:flex; align-items:center; justify-content:center;">답글 내용</span>
